...
export const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      { path: "/cnsd/transmitter-er-meter/:id/print", element: <CnsdTransmitterMeterPrintView /> },
      ...
      { path: "/tfp/genset-radar/:id/print", element: <TfpGensetRadarPrintView /> },
      {
        ...
        children: [
          ...
          { path: "/cnsd/transmitter-er-meter", element: <CnsdTransmitterMeterListPage /> },
          { path: "/cnsd/transmitter-er-meter/:id", element: <CnsdTransmitterMeterDetailPage /> },
