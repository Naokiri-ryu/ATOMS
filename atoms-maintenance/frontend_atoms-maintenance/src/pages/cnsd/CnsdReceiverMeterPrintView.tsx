  ...
  return (
    <div className="min-h-screen w-full bg-slate-100 p-4 text-black print:bg-white print:p-0">
      ...
      >
        ...
        {/* Items table — 6 cols: NO | PEMERIKSAAN | STATUS A | STATUS B | SQUELCH TX 1 | SQUELCH TX 2 */}
        <table className="gc-table">
          ...
          <thead>
            <tr className="text-center font-bold gc-section-bar">
              ...
              <th className="border border-black py-1" rowSpan={2}>SQUELCH ON TX1</th>
              <th className="border border-black py-1" rowSpan={2}>SQUELCH ON TX2</th>
            </tr>
            <tr className="text-center font-bold gc-section-bar">
