            ...
            <tr className="bg-slate-50 text-slate-700">
              ...
              {isReceiver ? (
                <>
                  ...
                  <th className="px-2 py-2 text-center font-semibold border-b border-slate-200 min-w-[120px] text-[11px] uppercase tracking-wider">SQUELCH TX 1</th>
                </>
              ) : (
                <>
              ...
              <th className="px-2 py-2 text-center font-semibold border-b border-slate-200 min-w-[140px] text-[11px] uppercase tracking-wider">SQUELCH TX 2</th>
            </tr>
          </thead>
          <tbody>
            {groups.length === 0 ? (
