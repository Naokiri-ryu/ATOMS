        ...
        {TFP_CATEGORIES.map((cat) => {
          ...
          return (
            <button
              ...
              className="text-left rounded-2xl border-2 border-maintenance-tfp/30 bg-white p-5 shadow-sm hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200 group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-maintenance-tfp focus-visible:ring-offset-2"
            >
