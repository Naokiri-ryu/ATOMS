...
export const TfpTransmitterTxDetailPage: React.FC = () => {
  ...
  // window mendapat focus, yang akan me-reset state dan menggagalkan fokus input.
  // useEffect(() => {
  ...
  return (
    <div className="max-w-full space-y-6 animate-fade-in pb-20">
      ...
      <TfpTransmitterTxSignaturePanel record={record} onUpdated={(r) => setRecord(r)} isDirtyCheck={isDirtyCheck} />
