...
import type {
  ...
  TfpGensetDvorSignerInfo,
  TfpGensetDvorTechnicianRow,
...
export const TfpGensetDvorSignaturePanel: React.FC<Props> = ({ record, onUpdated }) => {
  ...
  type Column =
    | {
        ...
        label: string;
        info: TfpGensetDvorSignerInfo | null;
      }
    | {
        kind: 'technician';
        label: string;
        row: TfpGensetDvorTechnicianRow;
      };
  ...
  const handleSign = async (signature: string) => {
    ...
    try {
      const result = await tfpGensetDvorService.signRecord(
        record.id,
        pending.role,
        signature,
