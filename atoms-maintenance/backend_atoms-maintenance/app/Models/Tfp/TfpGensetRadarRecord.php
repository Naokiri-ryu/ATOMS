...
class TfpGensetRadarRecord extends Model
{
    ...
    {
        return $this->hasMany(TfpGensetRadarTechnician::class, 'genset_radar_record_id')
            ->orderBy('sort_order')
            ->orderBy('id');
    }
    ...
    {
        return $this->hasMany(TfpGensetRadarItem::class, 'genset_radar_record_id')
            ->orderBy('sort_order')
            ->orderBy('id');
    }
    ...
    {
        return $this->hasMany(TfpGensetRadarFacility::class, 'genset_radar_record_id')
            ->orderBy('sort_order')
            ->orderBy('id');
    }
