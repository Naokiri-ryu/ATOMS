...
const LandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-[100dvh] flex flex-col items-center justify-center bg-gradient-to-b from-navy-700 via-navy-800 to-navy-900 px-4 overflow-hidden relative">
      {/* Wave Layer */}
      <div className="absolute bottom-0 left-0 right-0 h-1/2 md:h-1/3 min-h-[250px] transform origin-bottom scale-[1.35] md:scale-100">
        ...
        >
          ...
          ></path>
          {/* Amber Wave - Lapisan kedua (lebih dekat dengan navy) */}
          <path 
            fill="#F5A623" 
            fillOpacity="0.15" 
      ...
      <div className="relative z-10 max-w-4xl w-full text-center flex flex-col items-center justify-center space-y-2 md:space-y-5 py-4">
        ...
        <div className="space-y-2 md:space-y-2 animate-fade-slide-down">
          ...
          <h2 className="text-sm md:text-xl font-semibold text-navy-100">
        ...
        <div className="space-y-2 md:space-y-2 animate-fade-in-delay-2 w-full max-w-3xl">
          <h3 className="text-2xl md:text-[32px] font-bold text-white">
            Welcome!
          </h3>
          <div className="space-y-0">
            <p className="text-sm md:text-base max-w-2xl mx-auto leading-relaxed text-navy-100/80">
              Enjoy a new experience with ATOMS
            </p>
            <p className="text-sm max-w-2xl mx-auto leading-relaxed text-navy-100/60">
        ...
        <div className="pt-2 md:pt-3 animate-fade-scale-up w-full max-w-xs">
          <button
            ...
            className="w-full bg-accent-500 hover:bg-accent-400 text-navy-900 font-semibold text-base px-8 py-3 rounded-full shadow-lg shadow-navy-900/40 transition-all duration-300 hover:shadow-xl"
          >
            Get Started
          </button>
        </div>
