        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center space-x-3">
              <button onClick={() => navigate("/notifications")} className="p-2 hover:bg-white/10 rounded-lg transition-colors">
                <Bell className="h-5 w-5" />
              </button>
              <button onClick={() => navigate("/home")} className="flex items-center space-x-2 hover:bg-white/10 px-3 py-2 rounded-lg transition-colors">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-xl shadow-sm p-12 text-center">
          <div className="max-w-md mx-auto">
            ...
            <p className="text-gray-600 mb-6">The Inventory Management feature is under development and will be available soon.</p>
            <button onClick={() => navigate("/home")} className="bg-navy-700 hover:bg-navy-800 text-white px-6 py-3 rounded-xl font-semibold transition-colors shadow-md hover:shadow-lg">
              Back to Home
            </button>
          </div>
        </div>
